...
func loadSnapshot(diskdb kaidb.KeyValueStore, triedb *trie.TrieDatabase, cache int, root common.Hash) (snapshot, error) {
	...
	journal := kvstore.ReadSnapshotJournal(diskdb)
	if len(journal) == 0 {
